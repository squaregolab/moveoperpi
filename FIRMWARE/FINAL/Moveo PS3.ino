...
void loop() {
  ...
  if (PS3.PS3Connected || PS3.PS3NavigationConnected) {
    ...
    delayMicroseconds(1000);
        ...
        if (PS3.getButtonPress(L1) && PS3.getAnalogHat(RightHatY) > 200){
        for (int i=0; i<200; i++)
    ...
    delayMicroseconds(1000);
        ...
        if (PS3.getButtonPress(L1) && PS3.getAnalogHat(RightHatY) < 55){
         for (int i=0; i<200; i++)
   ...
   //Serial.print(F("\tRightHatY: "));
        //Serial.print(PS3.getAnalogHat(RightHatY));
        if (PS3.getButtonPress(R1) && PS3.getAnalogHat(RightHatY) > 200){
        for (int i=0; i<200; i++)
    ...
    delayMicroseconds(1000);
        ...
        if (PS3.getButtonPress(R1) && PS3.getAnalogHat(RightHatY) < 55){
         for (int i=0; i<200; i++)
    ...
    if (PS3.getAnalogButton(L2) || PS3.getAnalogButton(R2)) {
      ...
      myservo.write(15+PS3.getAnalogButton(L2)*0.44);
      //}
